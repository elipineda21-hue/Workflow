...
export const CAM_DB = [
  ...
  { brand: "Digital Watchdog", models: [
    ...
    { model: "DWC-XSBA05LiP", name: "MEGApix 5MP LiP Bullet", resolution: "5MP", lens: "2.8mm", type: "Bullet", codec: "H.265", fps: "30", bitrate: "4096", port: "80", rtspPort: "554", ptz: false, specSheet: "" },
  ]},
];
