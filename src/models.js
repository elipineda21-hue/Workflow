...
export const mkCamGroup = () => ({ id: uid(), brand: "", model: "", codec: "H.265", resolution: "4MP", lens: "2.8mm", type: "Outdoor Dome", port: "80", rtspPort: "554", fps: "15", bitrate: "", ptz: false, username: "", password: "", quantity: "4", ipStart: "", devices: [], noProgramming: false, ...mkProcurement() });
export const mkCamDev = (ip = "", idx = 0) => ({ id: uid(), name: `Camera ${String(idx + 1).padStart(2, "0")}`, cableId: `FCAM-${String(idx + 1).padStart(3, "0")}`, ip, mac: "", serial: "", notes: "", installed: false, programmed: false });
export const mkSwGrp = () => ({ id: uid(), brand: "", model: "", vlan: "", uplink: "", quantity: "1", ipStart: "", devices: [], noProgramming: false, ...mkProcurement() });
export const mkSwDev = (ip = "", idx = 0) => ({ id: uid(), name: `Switch ${String(idx + 1).padStart(2, "0")}`, cableId: `NSW-${String(idx + 1).padStart(3, "0")}`, ip, mac: "", serial: "", ports: "", notes: "", installed: false, programmed: false });
export const mkSrvGrp = () => ({ id: uid(), brand: "", model: "", role: "VMS Server", os: "", storage: "", quantity: "1", ipStart: "", devices: [], noProgramming: false, ...mkProcurement() });
export const mkSrvDev = (ip = "", idx = 0) => ({ id: uid(), name: `Server ${String(idx + 1).padStart(2, "0")}`, cableId: `SVR-${String(idx + 1).padStart(3, "0")}`, ip, mac: "", serial: "", notes: "", installed: false, programmed: false });
export const mkDoorGrp = () => ({ id: uid(), brand: "", model: "", readerType: "OSDP", credentialType: "Smart Card", lockType: "Electric Strike", cardFormat: "", facilityCode: "", accessGroup: "", schedule: "", quantity: "1", devices: [], noProgramming: false, ...mkProcurement() });
export const mkDoorDev = (idx = 0) => ({ id: uid(), name: `Door ${String(idx + 1).padStart(2, "0")}`, cableId: `IDR-${String(idx + 1).padStart(3, "0")}`, controllerName: "", controllerIP: "", controllerSerial: "", readerSerial: "", rex: false, doorContact: false, notes: "", installed: false, programmed: false });
export const mkZoneGrp = () => ({ id: uid(), zoneType: "Motion", partitions: "", bypassable: false, quantity: "1", startNumber: "1", devices: [], noProgramming: false, ...mkProcurement() });
export const mkZoneDev = (idx = 0, g = {}) => ({ id: uid(), name: `Zone ${String(idx + 1).padStart(2, "0")}`, cableId: `ZDR-${String(idx + 1).padStart(3, "0")}`, zoneNumber: String((parseInt(g.startNumber) || 1) + idx), zoneType: g.zoneType || "Motion", partitions: g.partitions || "", bypassable: g.bypassable || false, notes: "", installed: false, programmed: false });
export const mkSpkGrp = () => ({ id: uid(), brand: "", model: "", zoneGroup: "", ampZone: "", volume: "70", quantity: "1", ipStart: "", devices: [], noProgramming: false, ...mkProcurement() });
export const mkSpkDev = (ip = "", idx = 0) => ({ id: uid(), name: `Speaker ${String(idx + 1).padStart(2, "0")}`, cableId: `SPK-${String(idx + 1).padStart(3, "0")}`, ip, notes: "", installed: false, programmed: false });
export const mkSoftGrp = () => ({ id: uid(), brand: "", model: "", softwareType: "VMS License", licenseKey: "", seats: "1", subscription: false, renewalDate: "", quantity: "1", devices: [], noProgramming: true, ...mkProcurement() });
export const mkSoftDev = (idx = 0) => ({ id: uid(), name: `License ${String(idx + 1).padStart(2, "0")}`, cableId: `SFT-${String(idx + 1).padStart(3, "0")}`, licenseKey: "", activationDate: "", expiryDate: "", assignedTo: "", notes: "", installed: false, programmed: false });
export const genSoft = g => Array.from({ length: Math.min(parseInt(g.quantity) || 1, 64) }, (_, i) => mkSoftDev(i));
